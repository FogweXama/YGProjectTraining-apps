<?php
    class User{
        ...
        public function create($fields=array()){
            if($this->_db->insert('tblhouse', $fields)){
                throw new Exception("There was a problem creating account!", 1);
                
            }
        }

        public function find($house=null){
            // $data = null;
            if($house){
                $field=(is_numeric($user)) ? 'Price': 'Location';
                $data = $this->_db->get('tblhouse', array($field, '=', $house));
        ...
        public function update($fields=array()){
            ...
            if(!$this->_db->update('tblhouse', $id, $fields)){
